$( document ).ready(function() {
    ...
    /** MAP METHOD*/
    //Creates an array populated with with the results of calling a provided function on every element in the array.
...
console.log(bucket);
    ...
    let total = grades.reduce((prevValue, currentValue) => prevValue + currentValue)


    //average of grades
    console.log(total/grades.length)

//other example: to get the number of specialties form the food array
